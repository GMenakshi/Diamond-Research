...
/**
 * @typedef {Object} SearchableStock
 * @property {string} ticker - The stock's ticker symbol.
 * @property {string} companyName - The name of the company.
 * @property {number} price - The current price of the stock.
 * @property {number} priceChangePercentage - The percentage change in the stock price.
 * @property {number} priceChange - The actual change in the stock price.
 * @property {string} image - URL or path to an image associated with the stock or company.
 */

/**
 * Example of how you can use the SearchableStock type in your code.
 * @type {SearchableStock}
 */
